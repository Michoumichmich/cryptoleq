...
public:
    ...
    friend bool operator<(const Unumber &n1, const Unumber &n2) { return 0 != cless(&n1.z, &n2.z); }
    ...
    friend bool operator==(const Unumber &n1, const Unumber &n2) { return 0 != cequal(&n1.z, &n2.z); }
